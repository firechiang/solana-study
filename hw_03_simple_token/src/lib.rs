...
mod Test {
    ...
    use crate::amount_to_ui_amount_string_trimmed;

    #[test]
    fn test_amount_to_ui_amount_string_trimmed() {
        let amount:u64 = 18446744073709551610;
        let decimals:u8 = 8;
        let val:String = amount_to_ui_amount_string_trimmed(amount,decimals);
        println!("val={}",val);
    }
