 ...
 * @param programId
 */
const phantomCreateDataAccount = async (connection: Connection, provider: PhantomProvider, programId: PublicKey): Promise<string> => {
    try {
        /**
         ...
         */
        const [pdaAccountKey, _bump] = PublicKey.findProgramAddressSync([provider.publicKey.toBuffer()],programId);
...
export default phantomCreateDataAccount;